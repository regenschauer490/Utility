...
#ifndef SIGUTIL_HISTGRAM_HPP
#define SIGUTIL_HISTGRAM_HPP
...
public:
	...
	*/
	...
	/// ファイルへ出力
	void print(FilepassString const& file_pass, bool is_overwrite) const
	{
		std::ofstream ofs(file_pass, is_overwrite ? std::ios::out : std::ios::out | std::ios::app);
		print_base_(ofs);
	}
};
